//package org.tis.tools.security.exception;
//
...
//
///**
// * describe: 重写OAuth2的异常处理，增强对Hystrix的异常捕获处理能力
// *
// * @author zhaoch
// * @date 2018/6/3
// **/
//public class ToolsWebResponseExceptionTranslator extends DefaultWebResponseExceptionTranslator {
//
//    private static final Logger LOGGER = LoggerFactory.getLogger(ToolsWebResponseExceptionTranslator.class);
//
//    @Override
