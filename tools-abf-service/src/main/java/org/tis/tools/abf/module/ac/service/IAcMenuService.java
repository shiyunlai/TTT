...
public interface IAcMenuService extends IService<AcMenu>  {
     ...
     * @exception AcMenuManagementException
     */
    boolean deleteAllSubAcMenu(String menuGuid) throws AcMenuManagementException;
     ...
     * @exception AcMenuManagementException
     */
     boolean updateAcMenu(AcMenu acMenu) throws AcMenuManagementException;
     ...
     * @exception AcMenuManagementException
     */
    boolean createChildMenu(AcMenu acMenu) throws AcMenuManagementException;
     ...
     * @exception AcMenuManagementException
     */
    boolean createRootMenu(AcMenu acMenu) throws AcMenuManagementException;
