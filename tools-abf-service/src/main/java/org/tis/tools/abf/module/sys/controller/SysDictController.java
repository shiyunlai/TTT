...
public class SysDictController  extends BaseController {
    ...
    public ResultVO querySysDict(@RequestBody @Validated String id) {
        return ResultVO.success("查询成功",iSysDictService.querySysDictByGuid(id));
    }
    ...
    public ResultVO querySysDictList(@RequestBody @Validated SysDictRequest request){
...
//        }
    ...
    /**
     * 根据key 和 name查询业务字典信息
     *
     */

    @RequestMapping("/dictKeyOrQuery")
