...
import org.tis.tools.abf.module.sys.service.ISysRunConfigGenerator;
...
public class ISysRunConfigImpl extends ServiceImpl<SysRunConfigMapper, SysRunConfig> implements ISysRunConfigService {
    /** 拷贝新增时，代码前缀  */
            ...
            if( !"".equals(guid)){
                ...
                if( list== null){
                    throw new SysManagementException(
                            ...
                            wrap(SysRunConfig.COLUMN_GUID,guid),SysRunConfig.TABLE_NAME);
                }
            }else{
                list = ((selectList(wrapper)));
            }
