...
//        String groupGuid = data.getGuidGroup();
//        String empGuid = data.getGuidEmp();
//        employeeRService.deleteEmpGroup(groupGuid, empGuid);Wherecon
//        return getReturnMap(data);
//    }
//
//    /**
...
//        List<org.tis.tools.model.po.om.OmGroupPosition> list = new ArrayList<>();
//        for (String posGuid : posGuidlist) {
//            org.tis.tools.model.po.om.OmGroupPosition ogp = new org.tis.tools.model.po.om.OmGroupPosition();
